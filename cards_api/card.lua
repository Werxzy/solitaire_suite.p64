--[[pod_format="raw",created="2024-03-16 12:26:44",modified="2024-03-22 21:29:12",revision=10283]]
...
function card_draw(c)
	local facing_down = (c.a()-0.375) % 1 < 0.25 -- facing 45 degree limit for facing down
